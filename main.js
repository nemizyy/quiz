import { randint,shuffle,Question } from "./scripts.js"
...
function create_result(){
    ...
    h2.className = 'res'
    h2.innerHTML = `Num of questions -  ${qws.count}`
    h2.appendChild = div_finish.appendChild(h2)

    let h3 = document.createElement('h2')
    h3.className = 'res'
    h3.innerHTML = `Correct -  ${qws.correct_count}`
    h3.appendChild = div_finish.appendChild(h3)

    let h4 = document.createElement('h2')
    h4.className = 'res'
    h4.innerHTML = `Percents -  ${qws.correct_count/qws.count*100}%`
